...
const SCREENSHOT_PATH = "./reports/"+ datetime +"/screenshots/";

const config = { // we use a nightwatch.conf.js file so we can include comments and helper functions
    "src_folders": [
      "test/"     // we use '/test' as the name of our test directory by default. So 'test/e2e' for 'e2e'.
    ],
    "output_folder": "./reports/"+ datetime +"/", // reports (test outcome) output by Nightwatch
    ...
    "selenium": {
      ...
      "test_workers" : {
        "enabled" : true, 
        "workers" : "auto"}, // perform tests in parallel where possible
        ...
        "local": {
            ...
            "desiredCapabilities": {
              ...
              "chromeOptions": {
                ...
                // ],
                "args" : ["--no-sandbox", "--start-maximized","--incognito"],
                "w3c": false,
